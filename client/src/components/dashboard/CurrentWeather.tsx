        ...
        <div className="mt-6">
          ...
          <div className="flex overflow-x-auto py-2 justify-between">
            {(() => {
              ...
              // Robust hourly forecast parsing with error handling
                ...
                data.hourly.time.forEach((timeStr, index) => {
                  try {
                    ...
                    if (hour >= nextHour || time.getDate() > new Date().getDate()) {
                      ...
                      const temp = Math.round(data.hourly.temperature?.[index] || 0);
                      const code = data.hourly.weatherCode?.[index] || 0;
              ...
              // Limit to first 6 hours to prevent overflow
              const displayItems = hourlyItems.slice(0, 6);
